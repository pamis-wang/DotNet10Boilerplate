...
/// <summary> 跨租戶用戶權限領域模型 </summary>
public class CrossTenantUserPermissionDomainModel : AuditableDomainModel
{
    ...
    public List<CrossTenantUserPermissionDomainModel> Children { get; set; } = [];
}
