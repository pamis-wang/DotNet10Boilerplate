...
/// <summary> 用戶權限領域模型 </summary>
public class SingleTenantUserPermissionDomainModel : AuditableDomainModel
{
    ...
    public List<SingleTenantUserPermissionDomainModel> Children { get; set; } = [];
}
