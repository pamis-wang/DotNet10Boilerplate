...
/// <summary> 跨租戶用戶可用資源定義實體模型 </summary>
[Table("cross_tenant_resources")]
[Comment("跨租戶用戶可用資源定義資料表")]
[Index(nameof(TenantId), nameof(ParentId), Name = "ix_cross_tenant_resources_tenant_parent")]
public class CrossTenantResourceEntityModel : AuditableEntityModel
{
