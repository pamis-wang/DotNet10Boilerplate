...
/// <summary> 用戶登入方式實體模型 </summary>
[Table("single_tenant_user_logins")]
[Comment("用戶登入方式資料表")]
[Index(nameof(UserId), nameof(LoginMethod), Name = "uq_single_tenant_user_logins_user_method", IsUnique = true)]
public class SingleTenantUserLoginEntityModel : AuditableEntityModel
{
