...
using Dotnet10Boilerplate.Infrastructure.MainEntityModels.SingleTenantUser.Permission;
using Microsoft.EntityFrameworkCore;
using System.ComponentModel.DataAnnotations;
using System.ComponentModel.DataAnnotations.Schema;

namespace Dotnet10Boilerplate.Infrastructure.MainEntityModels.SingleTenantUser;

/// <summary> 用戶實體模型 </summary>
[Table("single_tenant_users")]
[Comment("用戶資料表")]
[Index(nameof(Account), Name = "uq_single_tenant_users_account", IsUnique = true)]
[Index(nameof(Email), Name = "uq_single_tenant_users_email", IsUnique = true)]
public class SingleTenantUserEntityModel : AuditableEntityModel
{
    ...
    public virtual ICollection<SingleTenantUserLoginEntityModel> UserLogins { get; set; } = [];
}
