...
/// <summary> 多租戶用戶角色權限設定實體模型 </summary>
[Table("multi_tenant_role_permissions")]
[Comment("多租戶用戶角色權限設定資料表")]
[Index(nameof(TenantId), nameof(RoleId), nameof(ResourceId), Name = "uq_multi_tenant_role_permissions_tenant_role_resource", IsUnique = true)]
public class MultiTenantRolePermissionEntityModel : AuditableEntityModel
{
    ...
    /// <summary> 資源 </summary>
    public virtual MultiTenantResourceEntityModel? Resource { get; set; }
}
