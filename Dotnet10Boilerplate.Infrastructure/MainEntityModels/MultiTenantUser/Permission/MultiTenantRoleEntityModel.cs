...
/// <summary> 多租戶用戶角色實體模型 </summary>
[Table("multi_tenant_roles")]
[Comment("多租戶用戶角色資料表")]
[Index(nameof(TenantId), nameof(Name), Name = "uq_multi_tenant_roles_tenant_name", IsUnique = true)]
public class MultiTenantRoleEntityModel : AuditableEntityModel
{
